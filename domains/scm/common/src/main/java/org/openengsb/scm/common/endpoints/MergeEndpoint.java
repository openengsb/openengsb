 ...
 */
public class MergeEndpoint extends AbstractScmEndpoint {
    private static final String BEHAVIOR = "merging branch to trunk.";
    ...
    protected void processInOutRequest(MessageExchange exchange, NormalizedMessage in, NormalizedMessage out)
        ...
        // execute call
        Command<MergeResult> command = getCommandFactory().getMergeCommand(branchName);
