...
/**
 * The Endpoint to the commit-feature
 */
public class CommitEndpoint extends AbstractScmEndpoint {
    private static final String BEHAVIOR = "committing changes.";
    ...
    protected void processInOutRequest(MessageExchange exchange, NormalizedMessage in, NormalizedMessage out)
        ...
        String subPath = extractStringParameter(in, "./@" + ParameterNames.SUB_PATH);
        ...
        // execute call
        Command<MergeResult> command = getCommandFactory().getCommitCommand(author, message, subPath);
    ...
    protected String getEndpointBehaviour() {
        return CommitEndpoint.BEHAVIOR;
    }
