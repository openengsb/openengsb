 ...
 */
public class CheckoutEndpoint extends AbstractScmEndpoint {
    private static final String BEHAVIOR = "checking out repository to working-copy.";
    ...
    protected void processInOutRequest(MessageExchange exchange, NormalizedMessage in, NormalizedMessage out)
        ...
        // execute call
        Command<MergeResult> command = getCommandFactory().getCheckoutCommand(author);
    ...
    protected String getEndpointBehaviour() {
        return CheckoutEndpoint.BEHAVIOR;
    }
}
