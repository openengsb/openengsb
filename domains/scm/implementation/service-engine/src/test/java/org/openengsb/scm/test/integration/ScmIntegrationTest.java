 ...
 */
package org.openengsb.scm.test.integration;
...
public class ScmIntegrationTest extends SpringTestSupport {
    ...
    public void inOut_shouldCheckoutRepositoryWhenCheckoutWasPassed() throws Exception {
        ...
        MergeResult result = doCheckoutRepository(CONSTANTS.SERVICE_ID1);

        // 2. validate result
        assertEquals(1, result.getAdds().length);

        // 3. validate filesystem
        File checkedOutFile = new File(CONSTANTS.WORKING_COPY1, CONSTANTS.TEST_FILE1);
    ...
    public void inOut_shouldPassCallToCorrectService() throws Exception {
        ...
        MergeResult result1 = doCheckoutRepository(CONSTANTS.SERVICE_ID1);
        MergeResult result2 = doCheckoutRepository(CONSTANTS.SERVICE_ID2);
        ...
        // 3. validate filesystem
        File checkedOutFile1 = new File(CONSTANTS.WORKING_COPY1, CONSTANTS.TEST_FILE1);
        File checkedOutFile2 = new File(CONSTANTS.WORKING_COPY2, CONSTANTS.TEST_FILE2);
    ...
    public void inOut_shouldFailWhenIdIsInknown() throws Exception {
        ...
        doCheckoutRepository(CONSTANTS.SERVICE_ID_UNKNOWN);
    }
    ...
    public void inOnly_shouldDeleteFileWhenDeleteWasPassed() throws Exception {
        // 1. checkout repository 1
        doCheckoutRepository(CONSTANTS.SERVICE_ID1);

        // 2. delete file
        doDeleteFile(CONSTANTS.TEST_FILE1, CONSTANTS.SERVICE_ID1);

        // 3. validate file's status
        File workingCopyDeleteFile = new File(new File(CONSTANTS.WORKING_COPY1), CONSTANTS.TEST_FILE1);
    ...
    public void inOnly_shouldPassCallToCorrectService() throws Exception {
        ...
        doCheckoutRepository(CONSTANTS.SERVICE_ID1);
        doCheckoutRepository(CONSTANTS.SERVICE_ID2);

        // 2. delete files
        doDeleteFile(CONSTANTS.TEST_FILE1, CONSTANTS.SERVICE_ID1);
        doDeleteFile(CONSTANTS.TEST_FILE2, CONSTANTS.SERVICE_ID2);

        // 3. validate file's status
        File workingCopyDeleteFile1 = new File(new File(CONSTANTS.WORKING_COPY1), CONSTANTS.TEST_FILE1);
        File workingCopyDeleteFile2 = new File(new File(CONSTANTS.WORKING_COPY2), CONSTANTS.TEST_FILE2);
    ...
    public void inOnly_shouldFailWhenIdIsUnknown() throws Exception {
        // exception expected here
        doDeleteFile(CONSTANTS.TEST_FILE1, CONSTANTS.SERVICE_ID_UNKNOWN);
    }
    ...
    public void inOut_shouldThrowExceptionWhenActuallyCallingInOnlyOperation() throws Exception {
        ...
        RobustInOnly inOnly = createRobustInOnlyMessage(client, CONSTANTS.TEST_SERVICE_NAME, "<execute id=\""
                + CONSTANTS.SERVICE_ID1 + "\">" + "<checkout " + " author=\"" + CONSTANTS.AUTHOR + "\"/>"
                + "</execute>");
    ...
    private MergeResult doCheckoutRepository(String id) throws Exception {
        ...
        DefaultServiceMixClient client = createClient();
        InOut inOut = createInOutMessage(client, CONSTANTS.TEST_SERVICE_NAME, "<execute id=\"" + id + "\">"
                + "<checkout " + " author=\"" + CONSTANTS.AUTHOR + "\"/>" + "</execute>");
    ...
    private void doDeleteFile(String deletePath, String id) throws Exception {
        DefaultServiceMixClient client = createClient();
        RobustInOnly inOnly = createRobustInOnlyMessage(client, CONSTANTS.TEST_SERVICE_NAME, "<execute id=\"" + id
    ...
    private void setEnvironmentVariables() throws Exception {
        ...
        String repository1 = new File(CONSTANTS.TRUNK1).toURI().toString();
        String repository2 = new File(CONSTANTS.TRUNK2).toURI().toString();

        setEnvironmentVariable(CONSTANTS.REPOSITORY1_ENV_NAME, repository1);
        setEnvironmentVariable(CONSTANTS.REPOSITORY2_ENV_NAME, repository2);
    ...
    private void deleteRepository() throws IOException {
        File repositoryPath1 = new File(CONSTANTS.REPOSITORY1);
        File repositoryPath2 = new File(CONSTANTS.REPOSITORY2);
    ...
    private void deleteWorkingCopies() throws IOException {
        String[] workingCopies = new String[] { CONSTANTS.WORKING_COPY1, CONSTANTS.WORKING_COPY2 };
