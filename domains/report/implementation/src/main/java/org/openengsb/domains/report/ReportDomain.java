...
public interface ReportDomain extends Domain {
    ...
    /**
     * Start collecting data for all arriving events with the given id of the given {@link IdType}. If the data
     * collection process is finished the report can be generated by calling the
     * {@link #generateReport(String, String, String)} method specifying the reportId returned by this method.
     * 
     * @return the reportId that can later be used to generate the report by calling
     *         {@link #generateReport(String, String, String)}
     */
    String collectData(IdType idType, String id);
