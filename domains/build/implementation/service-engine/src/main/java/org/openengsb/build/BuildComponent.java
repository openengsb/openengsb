 ...
 *                         description="Build domain Component"
 */
public class BuildComponent extends OpenEngSBComponent<OpenEngSBEndpoint> {
    @Override
    protected Class<?>[] getEndpointClasses() {
        return new Class[] { BuildEndpoint.class, EventForwardEndpoint.class };
    }
