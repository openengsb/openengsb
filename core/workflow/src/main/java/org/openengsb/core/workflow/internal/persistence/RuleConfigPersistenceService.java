...
public class RuleConfigPersistenceService implements ConfigPersistenceService<RuleConfiguration> {

    // configured via blueprint
    private ConfigPersistenceBackendService backend;

    @Override
    public RuleConfiguration load(Properties metadata) throws PersistenceException {
        // TODO creating transformer, transform and use configured backend service
        return null;
    }

    @Override
    public void persist(RuleConfiguration config) throws PersistenceException {
        // TODO creating transformer, transform and use configured backend service
    }
