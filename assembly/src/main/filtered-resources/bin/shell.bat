...
set CLASSPATH=%KARAF_HOME%\system\org\apache\karaf\shell\org.apache.karaf.shell.console\2.2.5-SNAPSHOT\org.apache.karaf.shell.console-2.2.5-SNAPSHOT.jar
