...
set CLASSPATH=%KARAF_HOME%\system\org\apache\karaf\admin\org.apache.karaf.admin.command\2.2.5-SNAPSHOT\org.apache.karaf.admin.command-2.2.5-SNAPSHOT.jar;%KARAF_HOME%\system\org\apache\karaf\admin\org.apache.karaf.admin.core\2.2.5-SNAPSHOT\org.apache.karaf.admin.core-2.2.5-SNAPSHOT.jar;%KARAF_HOME%\system\org\apache\karaf\shell\org.apache.karaf.shell.console\2.2.5-SNAPSHOT\org.apache.karaf.shell.console-2.2.5-SNAPSHOT.jar;%KARAF_HOME%\system\org\apache\aries\blueprint\org.apache.aries.blueprint\0.3.1\org.apache.aries.blueprint-0.3.1.jar;%KARAF_HOME%\system\org\ops4j\pax\logging\pax-logging-api\1.6.3\pax-logging-api-1.6.3.jar;%KARAF_HOME%\system\org\apache\felix\org.apache.felix.framework\3.0.9\org.apache.felix.framework-3.0.9.jar
