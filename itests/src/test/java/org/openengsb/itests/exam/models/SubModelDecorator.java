...
/**
 * The SubModelDecorator is a helper class for easier working with the SubModel class since it does the java
 * reflection calls for you on the SubModel object class instance
 */
public class SubModelDecorator {
    private Object model;

    public SubModelDecorator(Object model) {
        this.model = model;
    }
