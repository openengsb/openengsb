...
public class BuildDomainServiceManager extends AbstractServiceManager<BuildDomain, MavenServiceImpl> {

    public BuildDomainServiceManager(ServiceInstanceFactory<BuildDomain, MavenServiceImpl> factory) {
        super(factory);
    }
}
