...
public class JsonSecureRequestStringMarshallerFilterFactory implements FilterChainElementFactory {

    private GenericObjectSerializer objectSerializer;

    public JsonSecureRequestStringMarshallerFilterFactory() {
    }

    public JsonSecureRequestStringMarshallerFilterFactory(GenericObjectSerializer objectSerializer) {
        this.objectSerializer = objectSerializer;
    }

    @Override
    public FilterChainElement newInstance() throws FilterConfigurationException {
        return new JsonSecureRequestStringMarshallerFilter(objectSerializer);
    }
