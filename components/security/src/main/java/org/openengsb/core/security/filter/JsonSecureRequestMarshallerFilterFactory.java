...
public class JsonSecureRequestMarshallerFilterFactory implements FilterChainElementFactory {

    private GenericObjectSerializer objectSerializer;

    public JsonSecureRequestMarshallerFilterFactory() {
    }

    public JsonSecureRequestMarshallerFilterFactory(GenericObjectSerializer objectSerializer) {
        this.objectSerializer = objectSerializer;
    }

    @Override
    public FilterChainElement newInstance() throws FilterConfigurationException {
        return new JsonSecureRequestMarshallerFilter(objectSerializer);
    }
