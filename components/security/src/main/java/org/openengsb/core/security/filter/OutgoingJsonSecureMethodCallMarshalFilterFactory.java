...
public class OutgoingJsonSecureMethodCallMarshalFilterFactory implements FilterChainElementFactory {

    private GenericObjectSerializer objectSerializer;

    public OutgoingJsonSecureMethodCallMarshalFilterFactory() {
    }

    public OutgoingJsonSecureMethodCallMarshalFilterFactory(GenericObjectSerializer objectSerializer) {
        this.objectSerializer = objectSerializer;
    }

    @Override
    public FilterChainElement newInstance() throws FilterConfigurationException {
        return new OutgoingJsonSecureMethodCallMarshalFilter(objectSerializer);
    }
