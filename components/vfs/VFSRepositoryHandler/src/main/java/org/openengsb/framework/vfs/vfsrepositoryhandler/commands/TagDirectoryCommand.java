...
{
	@Argument(index = 0, name = "path", description = "The path of the Configuration that should be tagged", required = true, multiValued = false)
	String pathString;
	
	@Argument(index = 1, name = "tagName", description = "The name of the created tag", required = true, multiValued = false)
	String tagName;
