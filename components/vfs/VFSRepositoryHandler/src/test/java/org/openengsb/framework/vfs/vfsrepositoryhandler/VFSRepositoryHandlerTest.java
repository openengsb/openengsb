...
public class VFSRepositoryHandlerTest
{
	...
	public void testRepositoryPaths()
	{
		...
		verify(fileOperator).createDirectoryIfNotExists(repositoryPath);
		verify(fileOperator).createDirectoryIfNotExists(configurationPath);
		verify(fileOperator).createDirectoryIfNotExists(tagsPath);
	...
	public void testTagDirectory()
	{
		...
		verify(fileOperator).copyDirectory(configurationPath, expectedTagPath);
	}
