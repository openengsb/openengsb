...
public class MockedBundle implements Bundle {
    ...
    public Enumeration<URL> findEntries(String arg0, String arg1, boolean arg2) {
        ...
        if (full) {
            try {
                classes.add(new URL("file:/org/openengsb/core/ekb/modelregistry/tracker/models/ModelA.class"));
                classes.add(new URL("file:/org/openengsb/core/ekb/modelregistry/tracker/models/TestModel.class"));
