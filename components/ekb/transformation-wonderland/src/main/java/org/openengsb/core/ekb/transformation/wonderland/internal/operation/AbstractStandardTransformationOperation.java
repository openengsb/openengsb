...
/**
 * The AbstractStandardTransformationOperation is the abstract class for every TransformationOperation
 * provided by the transformation wonderland bundle.
 */
public abstract class AbstractStandardTransformationOperation implements TransformationOperation {
    private String operationName;
    
    public AbstractStandardTransformationOperation(String operationName) {
