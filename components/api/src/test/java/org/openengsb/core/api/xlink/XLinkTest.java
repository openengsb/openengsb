...
public class XLinkTest {
    ...
    @Test
    public void testPrepareXLinkURLAsTemplate_withOOIdentfier(){
        XLinkUrl url = ModelUtils.createEmptyModelObject(XLinkUrl.class);
        
        url.setUrl("http://openengsb.org/registryServlet.html");
        
        ExampleObjectOrientedIdentifier ooIdentifier = ModelUtils.createEmptyModelObject(ExampleObjectOrientedIdentifier.class);
        url.setIdentifier(ooIdentifier);
        
        String urlTemplate = XLinkUtils.returnXLinkUrl(url);
