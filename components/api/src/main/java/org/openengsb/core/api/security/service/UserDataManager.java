...
/**
 * Serves as a centralized store for User related data. It manages existing
 * users and their associated credentials, permissions and other metadata.
 * 
...
public interface UserDataManager {
     ...
     * @throws NoSuchCredentialsException if the user has no credentials of this
     *         type
     */
    ...
    /**
     * Removes the credentials of the specified type from the user. Future
     * invocations of {@link UserDataManager#getUserCredentials(String, String)}
     * with this type will result in a {@link NoSuchCredentialsException}.
     * 
     * If no credentials of this type were associated with the user in the first
     * place, this method does nothing.
     * 
     * @throws UserNotFoundException if the user does not exist
     */
     ...
     * </ul>
     * 
     * If the attribute only has a single value, the list will only contain the
     * one value.
     * 
     * The values are already of the correct type. So if a Long was stored as an
     * attribute, the object in the resulting list will be of type Long too.
     * 
     * @throws UserNotFoundException if the user does not exist
     * @throws NoSuchAttributeException if there is no attribute of that name
     ...
     * <li>Types having a constructor with exactly one argument of type String</li>
     * </ul>
     * the resulting list may contain any primitive type in its wrapped form or
     * strings.
     * 
     * If the attribute only has a single value, the list will only contain the
     * one value.
     ...
     * 
     * If no such attribute was associated with the user, this method does
     * nothing.
     * 
     * @throws UserNotFoundException if the user does not exist
     */
    ...
    /**
     * Retrieves all permissions directly associated with the user. This does
     * not include permissions that are implied by associated permissionSets.
     * 
     * @throws UserNotFoundException if the user does not exist
     */
    ...
    /**
     * Retrieves all permissions the user is granted. This includes permissions
     * granted by associated PermissionSets. The result must also include all
     * permissions granted by recursively all PermissionSets.
     * 
     * @throws UserNotFoundException if the user does not exist
     */
    ...
    /**
     * Retrieves all permissions of the given type directly associated with the
     * user. This does not include permissions that are implied by associated
     * permissionSets.
     * 
     * @throws UserNotFoundException if the user does not exist
     */
     ...
     * includes permissions granted by associated PermissionSets. The result
     * must also include all permissions granted by recursively all
     * PermissionSets.
     * 
     * @throws UserNotFoundException if the user does not exist
     */
     ...
     * 
     * If the user did not have a permission in the first place, nothing
     * happens.
     * 
     * @throws UserNotFoundException if the user does not exist
     */
     ...
     * 
     * @throws PermissionSetAlreadyExistsException if a permissionSet with that
     *         name already exists
     */
     ...
     * 
     * @throws PermissionSetNotFoundException if the permissionSet does not
     *         exist
     */
     ...
     * 
     * if the permissionSet did not contain a permission in the first place,
     * nothing happens.
     * 
     * @throws PermissionSetNotFoundException if the permissionSet does not
     *         exist
     ...
     * 
     * @throws UserNotFoundException if the user does not exist
     * @throws PermissionSetNotFoundException if one of the permissionSets does
     *         not exist
     */
     ...
     * 
     * If the user did not have such a permissionSet, or no such permissionSet
     ...
     * 
     * @throws PermissionSetNotFoundException if the parent permissionSet does
     *         not exist
     */
    ...
    /**
     * Retrieves all permissions directly associated with the parent
     * permissionSet. This does not include permissions that are implied by
     * child permissionSets.
     * 
     * @throws PermissionSetNotFoundException if the parent permissionSet does
     *         not exist
     */
    ...
    /**
     * Retrieves all permissions associated with the parent permissionSet. This
     * includes permissions recursively granted by associated PermissionSets.
     * The result must also include all permissions granted by recursively all
     * PermissionSets.
     * 
     * @throws PermissionSetNotFoundException if the parent permissionSet does
     *         not exist
