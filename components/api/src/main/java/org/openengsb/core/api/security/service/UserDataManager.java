...
/**
 * Serves as a centralized store for User related data. It manages existing users and their
...
public interface UserDataManager {
     ...
     * @throws NoSuchCredentialsException
     *             if the user has no credentials of this type
     */
     ...
     * 
     * If no credentials of this type were associated with the user in the first place, this method
     * does nothing.
     * 
     * @throws UserNotFoundException
     *             if the user does not exist
     ...
     * 
     * The values are already of the correct type. So if a Long was stored as an attribute, the
     ...
     *             if there is no attribute of that name associated with the user
     */
    ...
    /**
     * Retrieves all permissions directly associated with the user. This does not include
     * permissions that are implied
    ...
    /**
     * Retrieves all permissions the user is granted. This includes permissions granted by
     * associated PermissionSets.
    ...
    /**
     * Retrieves all permissions of the given type directly associated with the user. This does not
     * include permissions
    ...
    /**
     * Retrieves all permissions of the given type the user is granted. This includes permissions
     * granted by associated
     * PermissionSets. The result must also include all permissions granted by recursively all
     * PermissionSets.
     * 
     * @throws UserNotFoundException
     *             if the user does not exist
     ...
     *             if a permissionSet with that name already exists
     */
     ...
     *             if the permissionSet does not exist
     */
     ...
     *             if the user does not exist
     * @throws PermissionSetNotFoundException
     *             if one of the permissionSets does not exist
     */
     ...
     * 
     * If the user did not have such a permissionSet, or no such permissionSet exists, nothing
     * happens.
     * 
     * @throws UserNotFoundException
     *             if the user does not exist
     ...
     * 
     * @throws PermissionSetNotFoundException
     *             if the parent permissionSet does not exist
     */
    void removePermissionSetFromPermissionSet(String permissionSetParent, String... permissionSet)
        throws PermissionSetNotFoundException;

    /**
     * Returns a list the names of all permissionSets directly associated with the parent
     * permissionSet.
     * 
     * @throws PermissionSetNotFoundException
     *             if the parent permissionSet does not exist
    ...
    /**
     * Retrieves all permissions directly associated with the parent permissionSet. This does not
     * include permissions
    ...
    /**
     * Retrieves all permissions associated with the parent permissionSet. This includes permissions
     * recursively granted by associated
     * PermissionSets. The result must also include all permissions granted by recursively all
     * PermissionSets.
     * 
     * @throws PermissionSetNotFoundException
