...
public class RuleBaseConfiguration extends ConfigItem<RuleBaseElement> {
    ...
    public RuleBaseConfiguration(Map<String, String> metaData, RuleBaseElement content) {
        super(metaData, content);
    }

    public RuleBaseConfiguration(RuleBaseElement ruleBaseElement) {
        super(ruleBaseElement.toMetadata(), ruleBaseElement);
    }
