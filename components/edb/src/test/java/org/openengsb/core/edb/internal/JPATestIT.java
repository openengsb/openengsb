...
public class JPATestIT {
    ...
    public void testQueryOfOldVersionShouldWork() {
        ...
        EDBObject v23 = new EDBObject("/test/object4", data4v1);
        ci.add(v23);

        long time2 = db.commit(ci);

        HashMap<String, Object> data1v3 = new HashMap<String, Object>();
        data1v3.put("KeyA", "Value A 1");
        data1v3.put("KeyB", "Value A 1");
        EDBObject v31 = new EDBObject("/test/object1", data1v3);
        ci = db.createCommit("Blub", "Testing");
        ci.add(v31);
        ...
        data4v2.put("KeyA", "Value A 4");
        data4v2.put("KeyB", "Value A 1");
        EDBObject v33 = new EDBObject("/test/object4", data4v2);
        ci.add(v33);
