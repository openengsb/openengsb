...
public abstract class AbstractEDBFunctionTest extends AbstractEDBTest {
    ...
    public void testCommit_shouldWork() throws Exception {
        ...
        EDBObject obj = dataGenerator.createEDBObject("Tester");
        obj.putEDBObjectEntry("Test", "Hooray");
        EDBCommit ci = dataGenerator.createEDBCommit(Arrays.asList(obj), null, null);

        long time = db.commit(ci);

        obj = null;
        obj = dataGenerator.getEDBObject("Tester");
        String hooray = obj.getString("Test");

        assertThat(obj, notNullValue());
        assertThat(hooray, notNullValue());

        dataGenerator.assertStage(obj.getEDBStage());
    ...
    public void testGetInexistantObject_shouldThrowException() throws Exception {
        dataGenerator.getEDBObject("/this/object/does/not/exist");
    }

    @Test
    public void testGetCommits_shouldWork() throws Exception {
        EDBObject obj = dataGenerator.createEDBObject("TestObject");
        obj.putEDBObjectEntry("Bla", "Blabla");
        EDBCommit ci = dataGenerator.createEDBCommit(Arrays.asList(obj), null, null);

        long time = db.commit(ci);

        List<EDBCommit> commits1 = dataGenerator.getCommitsByKeyValue("context", "testcontext");
        List<EDBCommit> commits2 = dataGenerator.getCommitsByKeyValue("context", "DoesNotExist");

        assertThat(commits1.size(), is(1));
        assertThat(commits2.size(), is(0));

        dataGenerator.assertStage(commits1.get(0).getEDBStage());
    ...
    public void testGetHistoryAndCheckForElements_shouldWork() throws Exception {
        ...
        EDBObject v1 = dataGenerator.createEDBObject("/history/object", data1);
        ...
        EDBObject v2 = dataGenerator.createEDBObject("/history/object", data2);
        ci = getEDBCommit();
        ...
        EDBObject v3 = dataGenerator.createEDBObject("/history/object", data3);
        ci = getEDBCommit();
        ci.update(v3);
        ...
        List<EDBObject> history = dataGenerator.getHistory("/history/object");
        ...
        dataGenerator.assertStage(history.get(0).getEDBStage());
        dataGenerator.assertStage(history.get(1).getEDBStage());
        dataGenerator.assertStage(history.get(2).getEDBStage());
    ...
    public void testHistoryOfDeletion_shouldWork() throws Exception {
        ...
        List<EDBObject> history = dataGenerator.getHistory("/deletion/1");
    ...
    public void testGetLog_shouldWork() throws Exception {
        ...
        EDBObject v1 = dataGenerator.createEDBObject("/history/test/object", data1);
        EDBCommit ci = getEDBCommit();
        ...
        EDBObject v2 = dataGenerator.createEDBObject("/history/test/object", data2);
        ci = getEDBCommit();
        ...
        EDBObject v3 = dataGenerator.createEDBObject("/history/test/object", data3);
        ci = getEDBCommit();
        ci.update(v3);
        ...
        List<EDBLogEntry> log = dataGenerator.getLog("/history/test/object", time1, time4);
    ...
    public void testDiff_shouldWork() throws Exception {
        ...
        EDBObject v1 = dataGenerator.createEDBObject("/diff/object", data1);
        EDBCommit ci = getEDBCommit();
        ci.insert(v1);
        time1 = db.commit(ci);
        ...
        EDBObject v2 = dataGenerator.createEDBObject("/diff/object", data2);
        ci = getEDBCommit();
        ci.update(v2);
        time2 = db.commit(ci);
        ...
        EDBObject v3 = dataGenerator.createEDBObject("/diff/object", data3);
        ci = getEDBCommit();
        ci.update(v3);
        time3 = db.commit(ci);
        ...
        Diff diffAb = dataGenerator.getDiff(time1, time2);
        Diff diffBc = dataGenerator.getDiff(time2, time3);
        Diff diffAc = dataGenerator.getDiff(time1, time3);
    ...
    public void testGetResurrectedOIDs_shouldWork() throws Exception {
        Map<String, EDBObjectEntry> data1 = new HashMap<String, EDBObjectEntry>();
        putValue("KeyA", "Value A 1", data1);
        EDBObject v1 = dataGenerator.createEDBObject("/ress/object", data1);
        EDBCommit ci = getEDBCommit();
        ci.insert(v1);
        long time1 = db.commit(ci);

        v1 = dataGenerator.createEDBObject("/ress/object2", data1);
        ci = getEDBCommit();
        ci.insert(v1);
        ci.delete("/ress/object");
        long time2 = db.commit(ci);

        v1 = dataGenerator.createEDBObject("/ress/object", data1);
        ci = getEDBCommit();
        ci.delete("/ress/object2");
        ci.update(v1);
        long time3 = db.commit(ci);

        List<String> oids = dataGenerator.getResurrectedOIDs();
    ...
    public void testCommitTwiceSameCommit_shouldThrowError() throws Exception {
        Map<String, EDBObjectEntry> data1 = new HashMap<String, EDBObjectEntry>();
        putValue("KeyA", "Value A 1", data1);
        EDBObject v1 = dataGenerator.createEDBObject("/fail/object", data1);
        EDBCommit ci = getEDBCommit();
        ci.insert(v1);
        db.commit(ci);
        db.commit(ci);
    ...
    public void testCommitEDBObjectsInsert_shouldWork() throws Exception {
        EDBObject object = dataGenerator.createEDBObject("/commit/test/insert/1");
        ...
        object = dataGenerator.getEDBObject("/commit/test/insert/1");
    ...
    public void testCommitEDBObjectsInsertDouble_shouldThrowException() throws Exception {
        EDBObject object = dataGenerator.createEDBObject("/commit/test/insert/2");
        List<EDBObject> inserts = new ArrayList<EDBObject>();
        inserts.add(object);
    ...
    public void testIfConflictDetectionIsWorking_shouldThrowException() throws Exception {
        EDBObject object = dataGenerator.createEDBObject("/commit/test/insert/3");
        object.putEDBObjectEntry("bla", "blub");
        List<EDBObject> inserts = new ArrayList<EDBObject>();
        inserts.add(object);
        commitObjects(inserts, null, null);
        object = dataGenerator.getEDBObject("/commit/test/insert/3");
    ...
    public void testCommitEDBObjectsUpdate_shouldWork() throws Exception {
        EDBObject object = dataGenerator.createEDBObject("/commit/test/update/1");
        ...
        EDBObject first = dataGenerator.getEDBObject("/commit/test/update/1");
        ...
        EDBObject second = dataGenerator.getEDBObject("/commit/test/update/1");
    ...
    public void testCommitEDBObjectsUpdateVerstionConflict_shouldThrowException() throws Exception {
        EDBObject object = dataGenerator.createEDBObject("/commit/test/update/2");
        List<EDBObject> objects = new ArrayList<EDBObject>();
        objects.add(object);
        commitObjects(objects, null, null);
        object.putEDBObjectEntry(EDBConstants.MODEL_VERSION, Integer.valueOf(0));
    ...
    public void testCommitEDBObjectsUpdateVerstionConflict2_shouldThrowException() throws Exception {
        EDBObject object = dataGenerator.createEDBObject("/commit/test/update/3");
        commitObjects(Arrays.asList(object), null, null);
        EDBObject receive1 = dataGenerator.getEDBObject("/commit/test/update/3");
        EDBObject receive2 = dataGenerator.getEDBObject("/commit/test/update/3");
    ...
    public void testCommitEDBObjectsDelete_shouldWork() throws Exception {
        EDBObject object = dataGenerator.createEDBObject("/commit/test/delete/1");
        List<EDBObject> objects = new ArrayList<EDBObject>();
        objects.add(object);
        commitObjects(objects, null, null);
        commitObjects(null, null, objects);

        EDBObject entry = dataGenerator.getEDBObject("/commit/test/delete/1");
    ...
    public void testCommitEDBObjectsDeleteNonExisting_shouldThrowException() throws Exception {
        EDBObject object = dataGenerator.createEDBObject("/commit/test/delete/2");
        List<EDBObject> objects = new ArrayList<EDBObject>();
        objects.add(object);
        commitObjects(null, null, objects);
    }
    ...
    public void testCommitEDBObjectsDeleteAlreadyDeleted_shouldThrowException() throws Exception {
        EDBObject object = dataGenerator.createEDBObject("/commit/test/delete/3");
        List<EDBObject> objects = new ArrayList<EDBObject>();
        objects.add(object);
        commitObjects(objects, null, null);
        commitObjects(null, null, objects);
    ...
    public void testIfOtherTypesThanStringWorks_shouldProcessInteger() throws Exception {
        EDBObject object = dataGenerator.createEDBObject("test/type/integer");
        object.putEDBObjectEntry("value", Integer.valueOf(42));
        commitObjects(Arrays.asList(object), null, null);
        object = dataGenerator.getEDBObject("test/type/integer");
    ...
    public void testIfOtherTypesThanStringWorks_shouldProcessBoolean() throws Exception {
        EDBObject object = dataGenerator.createEDBObject("test/type/boolean");
        object.putEDBObjectEntry("value", Boolean.TRUE);
        commitObjects(Arrays.asList(object), null, null);
        object = dataGenerator.getEDBObject("test/type/boolean");
        Object value = object.getObject("value");
    ...
    public void testIfOtherTypesThanStringWorks_shouldProcessDate() throws Exception {
        EDBObject object = dataGenerator.createEDBObject("test/type/date");
        Date date = new Date();
        object.putEDBObjectEntry("value", date);
        commitObjects(Arrays.asList(object), null, null);
        object = dataGenerator.getEDBObject("test/type/date");
        Object value = object.getObject("value");
