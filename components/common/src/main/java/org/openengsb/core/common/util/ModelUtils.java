...
public final class ModelUtils {
    ...
    //
    // /**
    // * Tries to generate a model of the given class out of a wrapper. If something went wrong (e.g. the model
    // contained
    ...
    //
    // /**
    // * Tries to generate a model out of an OpenEngSB model wrapper. Without casting, only generating. If the model
    // class
    ...
    //
    // /**
    // * Tries to generate a model out of an OpenEngSB model wrapper. Uses the given class loader to load the model
    // class.
