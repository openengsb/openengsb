...
public class AuthenticatedSession extends org.apache.wicket.authentication.AuthenticatedWebSession {

    private Log log = LogFactory.getLog(AuthenticatedSession.class);
